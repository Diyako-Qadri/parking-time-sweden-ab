  ...
  return (
    <div className="bg-pt-background min-h-[800px] flex flex-col">
      <div className="flex flex-col text-center justify-center p-12">
        ...
        <div className=" relative h-full flex flex-col md:flex-row pt-8 pb-20 gap-12 items-center justify-center flex-wrap ">
          {ourteam.map((item, index) => (
            <div className="h-[430px] w-[296px] bg-white rounded-[20px] boxShadow">
              <div className="relative flex justify-center h-4/5 w-[290px] " key={index}>
                <Image
                  src={item.image}
