...
const HomeHero = () => {
    ...
    return(
        <>
        <section className='relative flex flex-col bg-top h-custom-home bg-homeHero-image justify-center bg-no-repeat top-[80px] bg-cover text-white md:h-lvh -z-10'>
