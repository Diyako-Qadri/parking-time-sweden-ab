...
const Footer = () => {
  ...
  return (
    <>
      <footer className="relative flex flex-col h-[776px] pb-[100px] md:justify-center md:h-80 md:py-[100px] w-full text-white bg-pt-primary md:px-3">
