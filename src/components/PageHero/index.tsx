...
const PageHero = ({ bgImage }: PageHeroProps) => {
    return(
        <section className={`flex flex-col ${bgImage} bg-cover bg-center justify-center h-custom-458 text-white pt-20 -z-50`}>
            <div className="p-7 md:px-16 backdrop-blur-sm  md:w-1/2 h-full">
