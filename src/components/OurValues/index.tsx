...
const OurValues = () => {
    return (
        ...
        <div className="flex w-full h-full bg-pt-background md:h-[878px]">
            ...
            <div className="block text-center border border-slate-950 bg-pt-background mb-6">  
                ...
                <div className="flex md:flex-row flex-col md:w-6/12 max-w-full p-8 pt-7"> 
                    ...
                    <div className="flex flex-col items-center border border-slate-950 bg-pt-background p-4  md:px-5  md:py-18">
                        ...
                        <p className="border text-center">We are striving to create simple and smooth experiences.</p>  
                    </div>
                    <div className="flex flex-col items-center border border-slate-950 bg-pt-background p-4 md:px-5 md:py-18">
